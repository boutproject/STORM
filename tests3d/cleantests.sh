...
# Remove data/output files from test runs
rm test-*/data/BOUT.dmp.* test-*/data/BOUT.restart.* test-*/data/BOUT.log.* test-*/data/BOUT.failed.* test-equilib-*/data/equilibrium/* test_equilib_1d.log test_filament_3d.log
